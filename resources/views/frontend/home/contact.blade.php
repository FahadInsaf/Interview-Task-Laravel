            ...
            <div class="row g-5">
                <div class="col-lg-6" data-sal="slide-up" data-sal-delay="150" data-sal-duration="800">
                    <div class="connect-thumbnail">
                        <div class="left-image">
                            <img src="{{asset('/frontend/images/contact/contact1.png')}}" alt="Nft_Profile">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6" data-sal="slide-up" data-sal-delay="200" data-sal-duration="800">
                    <div class="form-wrapper-one registration-area">
                        ...
                        <form class="" method="POST" action="{{url('savecontact')}}">
                                {{ csrf_field() }}
                            <div class="mb-5">
                            ...
                            <div class="mb-5">
                                ...
                                <textarea name="message" id="contact-message" rows="3"></textarea>
                            </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-12" data-sal="slide-up" data-sal-delay="150" data-sal-duration="800">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d52922.88303205875!2d71.98215005!3d34.00074745!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38ded2522a7c611b%3A0x63abebf29d7b68b1!2sNowshera%2C%20Khyber%20Pakhtunkhwa!5e0!3m2!1sen!2s!4v1660294107916!5m2!1sen!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </div>
